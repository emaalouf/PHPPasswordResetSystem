                ...
                <table class="email-content" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td class="email-masthead"
                            ...
                            align="center"><a href="https://example.com" class="email-masthead_name"
                                              style="box-sizing:border-box;color:#bbbfc3;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:16px;font-weight:bold;text-decoration:none;text-shadow:0 1px 0 white"><? echo constant("PRODUCT_NAME"); ?></a>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p style="box-sizing:border-box;color:#74787e;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:16px;line-height:1.5em;margin-top:0"
                                           align="left">You recently requested to reset your password for
                                            your <? echo constant("PRODUCT_NAME"); ?> account. Use the button below to
                                            reset it. <strong
                                                    style="box-sizing:border-box;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif">This
                                                password
                                        ...
                                        <p style="box-sizing:border-box;color:#74787e;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:16px;line-height:1.5em;margin-top:0"
                                           align="left">If you did not request a password reset, please ignore this
                                            email.</p>
                                        <p style="box-sizing:border-box;color:#74787e;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:16px;line-height:1.5em;margin-top:0"
                                           align="left">Thanks,
                                            <br/>The <? echo constant("PRODUCT_NAME"); ?> Team</p>
                                            ...
                                            <tr>
                                                <td style="box-sizing:border-box;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;word-break:break-word">
                                                    <p class="sub"
                                                       ...
                                                       align="left">If you’re having trouble with the button above, copy
                                                        and
                                                        paste the URL below into your web browser.</p>
                                                    <p class="sub"
                                                       style="box-sizing:border-box;color:#74787e;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:12px;line-height:1.5em;margin-top:0"
                                                       align="left"><? echo $reset_link; ?></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p class="sub align-center"
                                           ...
                                           align="center">© 2017 <? echo constant("PRODUCT_NAME"); ?>. All rights
                                            reserved.</p>
                                        <p class="sub align-center"
                                           style="box-sizing:border-box;color:#aeaeae;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;font-size:12px;line-height:1.5em;margin-top:0"
                                           align="center">
                                            <? echo constant("COMPANY_NAME"); ?>
                                            <br/><? echo constant("ADDR_LINE_1"); ?>
                                            <br/><? echo constant("ADDR_LINE_2"); ?>
                                        </p>
                                    </td>
                                </tr>
                            </table>
